...
// --- Evento para procesar el REGISTRO (SIN CAMBIOS) ---
registerForm.addEventListener('submit', (e) => {
    // 1. Evitamos que el formulario se recargue por defecto
    e.preventDefault();
...
loginForm.addEventListener('submit', (e) => {
    ...
    if (validUser) {
        ...
        // 1. Guarda el usuario actual en localStorage para mantener la sesión activa.
        // Usamos una clave diferente, como 'currentUser', para no confundir con la lista de 'users'.
